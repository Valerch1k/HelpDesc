...
{
    // Модель Заявка
    // Класс заявки будет представлять класс ключевого объекта системы.В зависимости от того,
    // насколько полную информацию предоставит пользователь в объекте заявки, настолько у него будут выше шансы,
    // что его заявка будет быстро и без проблем выполнена.
